...
class NodeBot():
    ...
    def init_bot_listener(self):
        print("[init_bot_listener] BOT_TOKEN:", repr(self.BOT_TOKEN))
        telegram.Bot(token=self.BOT_TOKEN).send_message(chat_id=self.CHAT_ID, text='TAMO EN VIVO!' + '🤙')
    ...
    def send_text(self, message):
        print("[send_text] BOT_TOKEN:", repr(self.BOT_TOKEN))
    ...
    def send_img(self, img, caption):
        print("[send_img] BOT_TOKEN:", repr(self.BOT_TOKEN))
